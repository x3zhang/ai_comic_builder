...
import { readPersistedStoryboardVersion } from "@/lib/storyboard-version-persist";
...
export default function EpisodeLayout({
  ...
  useEffect(() => {
    const stored = readPersistedStoryboardVersion(id, episodeId);
    void fetchProject(id, episodeId, stored || undefined);
